...
@interface ZCFoodLiveViewController () <WKNavigationDelegate>
...
- (void)viewDidLoad {
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.meipai.com/user/1047577070"]];
