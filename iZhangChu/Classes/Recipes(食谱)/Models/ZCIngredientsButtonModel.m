...
@implementation ZCIngredientsButtonModel
...
//- (CGSize)size {
//    if (!_size) {
//        _size = (kButtonW + kButtonPadding) + kLeftMargin + kFirstImageViewW + kButtonPadding;
//    }
//    return _size;
//}
//
//- (float)left {
//    if (!_left) {
//        _left = (kButtonW + kButtonPadding) + kLeftMargin + kFirstImageViewW + kButtonPadding;
//    }
//    return _left;
//}
//
